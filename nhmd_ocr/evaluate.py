...
#    model = VisionEncoderDecoderModel.from_encoder_decoder_pretrained("./nhmd_out/nhmd_small_full_271k_e", "./nhmd_out/nhmd_small_full_271k_d")
    ...
    # model = VisionEncoderDecoderModel.from_pretrained("./nhmd_out/base_full/checkpoint-160000")
    

    # ROBERTA FRESH
    # config = VisionEncoderDecoderConfig.from_pretrained("./nhmd_out/base_roberta/nhmd_base_roberta_final")
