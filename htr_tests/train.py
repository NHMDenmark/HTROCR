...
def train_hybrid(**kwargs):
    ...
    wandb_logger = WandbLogger(project='NHMD', name='NHMD_hybrid_271k')
    ...
    pretrained_filename = os.path.join(CHECKPOINT_PATH, "nhmd_hybrid_final.ckpt")
    ...
    trainer.save_checkpoint(os.path.join(CHECKPOINT_PATH, 'nhmd_hybrid_final.ckpt'))
